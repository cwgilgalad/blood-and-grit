...
**Current editions** — Player's Book v2.21 · Keeper's Book v2.9 · Bestiary v2.8 · GritKeeper v1.14.0.

*Latest change:* Player's Book v2.21 · Keeper's Book v2.9 — editorial pass: glossing the period idioms. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
