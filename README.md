...
**Current editions** — Player's Book v2.23 · Keeper's Book v2.10 · Bestiary v2.9 · GritKeeper v1.16.1.

*Latest change:* Keeper's Book v2.10 · Bestiary v2.9 — the magic systems reach the Keeper's side. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
