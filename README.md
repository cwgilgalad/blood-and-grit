...
**Current editions** — Player's Book v2.22 · Keeper's Book v2.9 · Bestiary v2.8 · GritKeeper v1.16.1.

*Latest change:* Player's Book v2.22 · GritKeeper v1.16.1 — rules consistency audit. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
