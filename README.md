...
**Current editions** — Player's Book v2.21 · Keeper's Book v2.9 · Bestiary v2.8 · GritKeeper v1.15.0.

*Latest change:* GritKeeper v1.15.0 — the Iron Code, adjudicated at the table. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
