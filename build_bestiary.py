...
# ---- cover / meta retext ----
_meta = [
 ("<!-- Blood & Grit — The Player's Book · Version 2.19 -->", "<!-- Blood & Grit — The Bestiary · Version 2.8 -->"),
 ("<title>Blood &amp; Grit — The Player's Book (Revised &amp; Expanded · v2.19)</title>", "<title>Blood &amp; Grit — The Bestiary (v2.8)</title>"),
 ...
 ('<p class="note" style="text-align:center; margin:0;">Blood &amp; Grit · The Player\'s Book · Version 2.19 · First Complete Edition</p>', '<p class="note" style="text-align:center; margin:0;">Blood &amp; Grit · The Bestiary · Version 2.8 · For the Keeper Alone</p>'),
]
for a,b in _meta:
