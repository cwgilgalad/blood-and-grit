...
public partial class MainForm
{
    ...
    void ShowLesson()
    {
        ...
        T("The mid-scene crib sheet: the four degrees, the DC ladder, a turn in the Iron Code, Threat by Tier, " +
          "wounds and lasting injuries, every condition, Nerve and Dread, the Mark, the Taint, Sign DCs, and Grit. " +
    ...
    void ShowShortcuts()
    {
        ...
        M("");
        H("Posse & Tracker");
        M("  Delete            Remove the selected soul / combatant");
        ...
        M("");
        H("Bestiary & pickers");
        M("  Double-click      Pop a creature out into its own window");
